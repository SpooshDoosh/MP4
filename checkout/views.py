...
def cache_checkout_data(request):
    try:
        ...
        messages.error(request, 'Sorry, your payment was unsuccessful \
    ...
    if request.method == 'POST':
        ...
        if order_form.is_valid():
            ...
            messages.error(request, 'It appears that there is an error within the form. \
                Please ensure thet all your information is correct.')
    else:
        bag = request.session.get('bag', {})
        if not bag:
    ...
    if request.user.is_authenticated:
        ...
        if save_info:
            profile_data = {
                ...
                'default_street_adress_2': order.street_adress_2,
